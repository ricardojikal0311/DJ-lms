...
START_DATE="2024-42-01"  # YYYY-MM-DD
END_DATE="2024-10-18"    # YYYY-MM-DD
...
commit_messages=(
    "fix: remove secret key"
    "last change"
    "Initial commit"
    "Minor design update"
    "Fix: student quiz permission and misconfigured template tag"
    "Restrict access to programs page for students"
    "Update requirements"
    "Multilingual support added"
    "Remove duplicate URLs"
    "Move language selector to sidebar"
    "Add languages and resolve conflicts"
    "Quiz form validation and UI fixes"
    "fixed issue: validation in choices"
    "Fix: invalid filter field"
    "Fix: student confirmation email"
    "Support sqlite3 and threaded email sending"
    "Minor UI improvements"
    "Student program edit form and minor updates"
    "Add .env.example and minor fixes"
